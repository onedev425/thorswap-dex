    ...
    Button: {
      ...
      variants: {
        ...
        fancy: {
          ...
          _hover: {
            bg: `linear-gradient(90deg, ${`${colors.btnSecondary}DD`} 0%, ${`${colors.blueLight}DD`} 80%)`,
            _disabled: {
              bg: `linear-gradient(90deg, ${`${colors.btnSecondary}DD`} 0%, ${`${colors.blueLight}DD`} 80%)`,
            },
          },
        ...
        fancyError: {
          ...
          _hover: {
            bg: `linear-gradient(90deg, ${`${colors.fancyErrorStart}DD`} 0%, ${`${colors.fancyErrorStop}DD`} 80%)`,
            _disabled: {
              bg: `linear-gradient(90deg, ${`${colors.fancyErrorStart}DD`} 0%, ${`${colors.fancyErrorStop}DD`} 80%)`,
            },
          },
