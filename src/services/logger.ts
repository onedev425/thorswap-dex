...
export const logEvent = (event: string, properties?: Record<string, Todo>) => {
  if (!posthogEnabled) {
...
export const logException = (error: Error | string, properties?: Record<string, Todo>) => {
...
export const identifyUser = (id: string, properties?: Record<string, Todo>) => {
  if (posthogEnabled) {
