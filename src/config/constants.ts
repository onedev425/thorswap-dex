...
export const THORSWAP_DOCUMENTATION_URL = 'https://docs.thorswap.finance/thorswap/';
...
export const STREAMING_SWAPS_URL = 'https://docs.thorswap.finance/thorswap/thorswap/streaming-swaps';
