...
export const assetFilterTypes: AssetFilterType[] = [
  ...
  { value: 'erc20', label: 'ERC20', tooltip: 'Ethereum Mainnet (ERC-20)' },
  { value: 'avax', label: 'ERC20', tooltip: 'Avalanche C-Chain (ERC-20)' },
  { value: 'bep2', label: 'BEP2', tooltip: 'BNB Beacon Chain (BEP2)' },
];
